...
// @ts-expect-error TS(7016) FIXME: Could not find a declaration file for module 'comp... Remove this comment to see the full error message
...
// @ts-expect-error TS(2614) FIXME: Module '"./config/passport"' has no exported membe... Remove this comment to see the full error message
import { jwtStrategy } from './config/passport';
import routes from './routes/v1';
// @ts-expect-error TS(2614) FIXME: Module '"./middlewares/error"' has no exported mem... Remove this comment to see the full error message
